...
%changelog
* Fri Oct 28 2022 jikui<jikui2@huawei.com> - 1:1.31.1-17
- fix use after free in bc module

* Wed Aug 31 2022 jikui<jikui2@huawei.com> - 1:1.31.1-16
- add Epoch field in spec file

* Fri Aug 19 2022 jikui<jikui2@huawei.com> - 1:1.31.1-15
- Type:CVE
- Id:NA
- SUG:NA
- DESC: fix CVE-2022-30065

* Tue Apr 19 2022 jikui<jikui2@huawei.com> - 1:1.31.1-14
- Type:CVE
- Id:NA
- SUG:NA
- DESC: fix CVE-2022-28391

* Mon Nov 29 2021 xiechengliang<xiechengliang1@huawei.com> - 1:1.31.1-13
- Type:CVE
- Id:NA
- SUG:NA
- DESC: fix CVE-2021-42378 CVE-2021-42379 CVE-2021-42380 CVE-2021-42381 CVE-2021-42382 CVE-2021-42383 CVE-2021-42384 CVE-2021-42385 CVE-2021-42386
...
* Mon Nov 22 2021 jikui<jikui2@huawei.com> - 1:1.31.1-10
- Type:CVE
- Id:NA
- SUG:NA
...
- Id:NA
- SUG:NA
- DESC:rollback busybox to 1.31.1

* Tue Apr 10 2021 jikui <jikui2@huawei.com> - 1:1.33.1-8
- Type:enhancement
- Id:NA
- SUG:NA
